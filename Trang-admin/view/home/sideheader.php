                ...
                <nav class="side-header-menu" id="side-header-menu">
                    <ul>
                        ...
                        <?php elseif ($role == ROLE_QUAN_LY_CUM): ?>
                            ...
                            <li><a href="index.php?act=quan_ly_tin_tuc" class="<?= $currentAct==='quan_ly_tin_tuc'?'is-active':''; ?>"><i class="zmdi zmdi-info-outline"></i> <span>Quản Lý Tin Tức</span></a></li>
                        ...
                        <?php elseif ($role == ROLE_NHAN_VIEN): ?>
                            ...
                            <li><a href="index.php?act=register_face"><i class="zmdi zmdi-account"></i> <span>Đăng ký khuôn mặt</span></a></li>
