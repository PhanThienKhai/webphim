    ...
    <form action="index.php?act=themphong" method="post"  enctype="multipart/form-data">
        <div class="add-edit-product-wrap col-12">
            <div class="add-edit-product-form">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-12 mb-30"><input class="form-control" type="text" placeholder="TÊN PHÒNG" name="name"></div>
                        <div class="col-lg-4 col-12 mb-30"><input class="form-control" type="number" placeholder="SỐ GHẾ" name="so_ghe" min="0"></div>
                        <div class="col-lg-4 col-12 mb-30"><input class="form-control" type="number" step="0.01" placeholder="DIỆN TÍCH (m²)" name="dien_tich" min="0"></div>
