            ...
            <div class="info-section">
                ...
                <div class="qr-section">
                    ...
                    <div class="qr-container">
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=' . urlencode('http://' . $_SERVER['HTTP_HOST'] . '/webphim/Trang-nguoi-dung/quete.php?id=' . $id) . '" alt="QR Code" class="qr-code">
                    </div>
