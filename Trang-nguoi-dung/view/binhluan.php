...
<body>
<?php
// Always show the number of comments to all visitors (guest or logged-in)
foreach ($dem_bl as $bl) {
    extract($bl);
...
<div class="comment-wrapper">
    <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
        ...
        <div class="comment-sets">
            <?php
                    // Show the list of comments to everyone. Only logged-in users may post (handled above).
                    if (!empty($listbl)) {
                            ...
                            echo "<p>Hiện chưa có bình luận nào. Hãy đăng nhập để trở thành người đầu tiên bình luận.</p>";
                    }
            ?>
