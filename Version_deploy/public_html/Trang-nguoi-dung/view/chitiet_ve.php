                            ...
                            <div class="ticket__inner">
                                ...
                                <div class="ticket-primery" style="position: relative;">
                                    <div style="position: absolute; top: 86px; right: -1px; width: 107px; height: 107px; background: #fff; border: 2px solid #e5e7eb; border-radius: 8px; display: flex; align-items: center; justify-content: center; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                                        <img src="view/qr.php?data=' . urlencode($protocol . "://" . $qr_host . "/webphim/Trang-nguoi-dung/quete.php?id=" . $id) . '&t=' . time() . '" alt="QR Code" style="width: 115px; height: 115px; object-fit: contain;" />
                                    </div>
...
$protocol = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? 'https' : 'http';
$qr_data = $protocol . "://" . ($_SERVER['HTTP_HOST'] ?? 'localhost') . "/webphim/Trang-nguoi-dung/index.php?act=quetve&id=" . $loadone_ve['id'];
?>
